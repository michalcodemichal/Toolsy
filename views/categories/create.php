...
<head>
    <meta charset="UTF-8">
    <title>Dodaj Kategorię - Panel Admina</title>
    <link rel="stylesheet" href="css/style.css">
</head>
<body>
    <header>
        <h1>Panel Admina - Dodaj Nową Kategorię</h1>
    ...
    <main>
        ...
        <form action="index.php?action=category_store" method="POST">
            <div>
                ...
                <input type="text" id="nazwa_kategorii" name="nazwa_kategorii" value="<?= htmlspecialchars($_POST['nazwa_kategorii'] ?? '') ?>" required>
            </div>
            <div>
                <label for="opis_kategorii">Opis (opcjonalnie):</label>
                <textarea id="opis_kategorii" name="opis_kategorii"><?= htmlspecialchars($_POST['opis_kategorii'] ?? '') ?></textarea>
            </div>
            <div>
